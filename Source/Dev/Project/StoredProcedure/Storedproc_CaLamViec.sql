...
as
begin
insert into CaLamViec(TenCaLamViec, GioBatDauCa, GioKetThucCa, GioBatDauGiaiLao, GioKetThucGiaiLao , TongGio, 
DiemCong, GioVaoSomNhatDuocTinhCa, GioVaoMuonNhatDuocTinhCa, GioRaMuonNhatDuocTinhCa, GioRaSomNhatDuocTinhCa, KhongCoGioRa, 
KhongCoGioVao, TruGioDiTre, ThoiGianDiTreChoPhep, TruGioVeSom, ThoiGianVeSomChoPhep, GioiHanTCMucMot, GioiHanTCMucHai,
SDMucTangCaCuaTangCaCuoiTuan, MucTangCaCuaTangCaCuoiTuan, SDMucTangCaCuaTangCaNgayLe, MucTangCaCuaTangCaNgayLe, GioiHanTCTruocGLV,
GioiHanTCSauGLV, CaQuaDem, TachGioCaDemTu, TachGioCaDemDen)
values (@TenCaLamViec, @GioBatDauCa, @GioKetThucCa, @GioBatDauGiaiLao, @GioKetThucGiaiLao, @TongGio, @DiemCong, @GioVaoSomNhatDuocTinhCa,
@GioVaoMuonNhatDuocTinhCa, @GioRaMuonNhatDuocTinhCa, @GioRaSomNhatDuocTinhCa, @KhongCoGioRa, @KhongCoGioVao, @TruGioDiTre, @ThoiGianDiTreChoPhep, 
@TruGioVeSom, @ThoiGianVeSomChoPhep, @GioiHanTCMucMot,@GioiHanTCMucHai,@SDMucTangCaCuaTangCaCuoiTuan, @MucTangCaCuaTangCaCuoiTuan, @SDMucTangCaCuaTangCaNgayLe, 
@MucTangCaCuaTangCaNgayLe, @GioiHanTCTruocGLV,@GioiHanTCSauGLV, @CaQuaDem, @TachGioCaDemTu, @TachGioCaDemDen);
end
go
